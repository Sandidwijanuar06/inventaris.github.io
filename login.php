...
<head>
  ...
  <title>AdminLTE 3 | Form Login User</title>
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="username">Username</label>   <i class="ion-person"></i>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            ...
                            <input type="password" class="form-control" name="password" placeholder="Enter Password" autofocus required>
                    </div>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label" for="exampleCheck1"><a href="register.php">Buat Akun</a></label>
                  </div>
                </div>
                <!-- /.card-body -->
