...
<head>
  ...
  <title>Inventaris | Laporan Daftar Peminjaman</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Daftar Peminjaman</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Laporan Daftar Peminjaman</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      ...
      <form class="form-inline float-right" method="post">
        ...
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Peminjaman</i></h3>
      </div>
        <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
                if(isset($_POST['tanggal'])){
                    ...
                    if(!empty($tgl_keluar)){
                        $query =  mysqli_query($con,"SELECT * FROM peminjaman WHERE MONTH(tgl_peminjaman)='$tgl_peminjaman'");
                    } else {
