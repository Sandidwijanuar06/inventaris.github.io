...
<head>
  ...
  <title>Inventaris | Laporan Daftar Barang Masuk</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="../../ogout.php" class="dropdown-item dropdown-footer">Log Out</a>
        </div>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Daftar Barang Masuk</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Laporan Daftar Barang Masuk</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      ...
      <form class="form-inline float-right" method="post">
                ...
                <select name="tgl_masuk" class="form-control ml-2" id="">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
                if(isset($_POST['tanggal'])){
                    $tgl_masuk = date($_POST['tgl_masuk']);

                    if(!empty($tgl_masuk)){
                        $query =  mysqli_query($con,"SELECT * FROM barang_masuk WHERE MONTH(tgl_masuk)='$tgl_masuk'");
                    } else {
            ...
            <tr>
                ...
                <td><?=$jenis_barang;?></td>
                <td><?=$jumlah;?></td>
                <td><?=date('d F Y', strtotime($tgl_masuk));?></td>
            </tr>
            <?php
              } 
            ?>
