...
<head>
  ...
  <title>Inventaris | Laporan Pengembalian</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      ...
      <form class="form-inline float-right" method="post">
                ...
                <select name="tgl_kembali" class="form-control ml-2" id="">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
                if(isset($_POST['tanggal'])){
                    $tgl_kembali = date($_POST['tgl_kembali']);

                    if(!empty($tgl_kembali)){
                        $query =  mysqli_query($con,"SELECT * FROM pengembalian WHERE MONTH(tgl_kembali)='$tgl_kembali'");
                    } else {
