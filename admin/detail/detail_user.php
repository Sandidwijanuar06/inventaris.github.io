            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <a href="../edit/edit_foto.php?id=<?=$data['id_user'];?>"" class="">
                    <img class="profile-user-img img-fluid img-circle"
                       src="../foto/<?php echo $data['foto'];?>"
                ...
                <p class="text-muted text-center"><?php echo $data['role'];?></p>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <label for="Nohpwa">No.hp/wa</label><br>
                    <div class="input-group">
                        <input type="text" class="form-control" value="<?php echo $data['no_hp_wa'];?>">
                    </div>
                  </li>
                  <li class="list-group-item">
                  <label for="role">Role</label><br>
                    <div class="input-group">
                        <input type="text" class="form-control" value="<?php echo $data['role'];?>">
                    </div>
                  </li>
                  <li class="list-group-item">
