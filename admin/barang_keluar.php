...
<head>
  ...
  <title>Inventaris | Daftar Barang Keluar</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Barang Keluar</i></h3>
      </div>
        <div class="card-body">
