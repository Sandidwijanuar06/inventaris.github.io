...
<head>
  ...
  <title>Inventaris | Daftar Petugas</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-header">
        <a href="tambah/tambah_user.php" class="btn btn-primary float-right"><i class="fas fa-plus"> Tambah User</i></a>
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Users</i></h3>
      </div>
        <div class="card-body">
