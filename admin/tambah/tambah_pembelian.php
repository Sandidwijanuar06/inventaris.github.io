...
<head>
  ...
  <title>Inventaris | Form Tambah Pembelian</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="ion-plus mr-2"></i>Tambah Pembelian</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                            <input type="text" class="form-control" name="jenis_barang" placeholder="Masukan Jenis Barang" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="harga_barang">Harga Barang</label>
                    <div class="input-group">
                            <input type="number" class="form-control" name="harga_barang" placeholder="Masukan Harga" required>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="tambah_pembelian">Submit</button>
                </div>
              </form>
            </div>
        </div>
