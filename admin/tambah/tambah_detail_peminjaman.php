...
$query = mysqli_query($con,"SELECT * FROM peminjaman WHERE peminjaman.id_peminjaman='$id_peminjaman'") or die(mysqli_error($con));
...
<head>
  ...
  <title>Inventaris | Form Tambah Detail</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="ion-plus mr-2"></i>Tambah Peminjama Barang</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="?id=<?=$_GET['id'];?>">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="tambah_detail">Submit</button>
                </div>
