...
<head>
  ...
  <title>Inventaris | Form Tambah User</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="ion-plus mr-2"></i>Tambah User</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="no_hp_wa" placeholder="No Handphone atau Whatsapp" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                    <textarea type="textarea" class="form-control" name="alamat" placeholder="Alamat" required></textarea>
                    </div>
                  </div>
                  <div class="form-group">
