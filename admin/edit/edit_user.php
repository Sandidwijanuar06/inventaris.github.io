...
$id_user = $_GET['id']; 
$query = mysqli_query($con, "SELECT * FROM user WHERE user.id_user='$id_user'");
...
<head>
  ...
  <title>Inventaris | Form Edit User</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Edit User</h3>
              </div>
              <form method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="no_hp_wa" value="<?=$data['no_hp_wa'];?>" >
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                    <textarea type="textarea" class="form-control" name="alamat" placeholder="Alamat" ><?=$data['alamat'];?></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
