    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="admin/daftar_barang.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="admin/barang_masuk.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="admin/barang_keluar.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="admin/pembelian_barang.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_masuk.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_keluar.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_daftar_barang.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_pembelian.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Laporan Pembelian 
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_peminjam.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Laporan Peminjam
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="admin/laporan/laporan_pengembalian.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
          ...
          <li class="nav-item menu-open">
            <a href="admin/petugas.php" class="nav-link">
