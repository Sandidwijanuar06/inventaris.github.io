...
<head>
  ...
  <title>Inventaris | Laporan Daftar Pembelian</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      ...
      <form class="form-inline float-right" method="post">
                ...
                <select name="tgl_pembelian" class="form-control ml-2" id="">
        ...
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Pembelian</i></h3>
      </div>
        <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
                if(isset($_POST['tanggal'])){
                    $tgl_pembelian = date($_POST['tgl_pembelian']);

                    if(!empty($tgl_pembelian)){
                        $query =  mysqli_query($con,"SELECT * FROM pembelian_barang WHERE MONTH(tgl_pembelian)='$tgl_pembelian'");
                    } else {
            ...
            <td><?=$i++;?></td>
            <td><?=$nama_barang;?></td>
            <td><?=date('d F Y', strtotime($tgl_pembelian));?></td>
            <td><?=$jenis_barang;?></td>
