...
<head>
  ...
  <title>Inventaris | Laporan Daftar Barang Keluar</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="laporan_daftar_barang.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
          ...
          <li class="nav-item menu-open">
            <a href="laporan_peminjam.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Laporan Peminjam
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="laporan_pengembalian.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Daftar Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Laporan Daftar Barang Keluar</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      ...
      <form class="form-inline float-right" method="post">
                ...
                <select name="tgl_keluar" class="form-control ml-2" id="">
                ...
                <button type="submit" class="btn btn-primary ml-2" name="tanggal">Submit</button>
            </form>
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Keluar</i></h3>
      </div>
        <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
                if(isset($_POST['tanggal'])){
                    $tgl_keluar = date($_POST['tgl_keluar']);

                    if(!empty($tgl_keluar)){
                        $query =  mysqli_query($con,"SELECT * FROM barang_keluar WHERE MONTH(tgl_keluar)='$tgl_keluar'");
                    } else {
            ...
            <td><?=$i++;?></td>
                <td><?=$nama_barang;?></td>
                <td><?=$kd_barang;?></td>
                <td><?=date('d F Y', strtotime($tgl_keluar));?></td>
                <td><?=$jumlah_keluar;?></td>
                <td><?=$status_keluar;?></td>
            </tr>
            <?php
