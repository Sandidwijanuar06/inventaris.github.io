...
<head>
  ...
  <title>Inventaris | Daftar Peminjam</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Peminjam</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"> <i class="fas fa-table"> Tabel Daftar Peminjam</i></h3>
        <a class="btn btn-primary float-sm-right" href="tambah/tambah_peminjam.php"><i class="ion-plus"> Tambah Peminjam</i></a>
      </div>
      <div class="card-body">
        ...
        <thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php
                  if($status=='Proses peminjaman'){
                    echo'
                    <a class="btn btn-warning" href="detail/detail_peminjaman.php?id='.$id_peminjaman.'"><i class="fas fa-eye"></i></a>
                    <a class="btn btn-success" href="edit/edit_peminjaman.php?id='.$id_peminjaman.'"><i class="ion-compose"></i></a>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#del'.$id_peminjaman.'">
                    <i class="fas fa-trash"></i>
                    </button>
                    ';
                  }
                  if($status=='Sedang meminjam'){
                    echo'
                    <a class="btn btn-warning" href="detail/detail_peminjaman.php?id='.$id_peminjaman.'"><i class="fas fa-eye"></i></a>
                    ';    
                  }
                  if($status=='Telah mengembalikan barang'){
                    echo'
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#selesaikan'.$id_peminjaman.'">
              ...
              <!-- Modal Selesaikam -->
              <div class="modal fade" id="selesaikan<?=$id_peminjaman;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <form method="post">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="hidden" name="tgl_peminjaman" value="<?= $tgl_peminjaman;?>">
                      Terimakasih telah meminjam dengan amanah.<br>
                      Untuk menyelesaikan peminjaman isi terlebih dahulu tanggal pengembelian setelah diisi klik "<strong>Selesaikan</strong>"
                      <br>
                      <br>
...
<!--------------------------------------- ----------------------------------------------------- ----------------------------------------------------- -->
              <!-- Modal Delete -->
              <div class="modal fade" id="del<?=$id_peminjaman;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                  <form method="post">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hapus Peminjam</h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <input type="hidden" name="id_peminjaman" value="<?= $id_peminjaman;?>">
                      Apakah anda yakin ingin menghapus peminjam ini(<strong><?=$nama_peminjam;?></strong>)? KLIK "<strong>HAPUS</strong>" jika yakin!
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" name="delete_peminjaman" class="btn btn-success">Hapus</button>
                    </div>
                    </div>
                  </form>
                </div>
