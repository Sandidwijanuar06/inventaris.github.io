...
<head>
  ...
  <title>Inventaris | Form Tambah Peminjam</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="ion-plus mr-2"></i>Tambah Peminjam</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="nama_peminjam" placeholder="Masukan Nama Peminjam" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="nohp">No.Handphone/Wa</label>
                    <div class="input-group">
                        <input type="number" maxlength="12" class="form-control" name="nohp" placeholder="Masukan Nomor Hp atau Wa" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea type="textarea" class="form-control" name="alamat" placeholder="Masukan Alamat" required></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="tambah_peminjaman">Submit</button>
                </div>
              </form>
            </div>
        </div>
